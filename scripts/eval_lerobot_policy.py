"""Evaluate a trained LeRobot policy in Isaac Sim.

Loads a LeRobot policy checkpoint and runs closed-loop evaluation
in the Isaac Sim Franka environment.

Usage:
    <ISAAC_SIM>/python.sh scripts/eval_lerobot_policy.py \
...
parser = argparse.ArgumentParser(description="Evaluate LeRobot policy in Isaac Sim")
