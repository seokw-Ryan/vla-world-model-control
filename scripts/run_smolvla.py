...
def load_policy(policy_path: str, device_override: str | None) -> tuple[SmolVLAPolicy, torch.device, AutoProcessor]:
...
def build_policy_batch(
    ...
    return {
        ...
        "observation.language_tokens": task_tokens,
        "observation.language_attention_mask": task_mask.to(dtype=torch.bool),
    }
...
def main() -> int:
    ...
    policy, device, processor = load_policy(args.policy_path, args.device)
